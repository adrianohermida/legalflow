  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ color: '#6b7280', marginBottom: '2rem', fontSize: '1.2rem' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ color: '#667eea', marginBottom: '10px' }}>📊 Dashboard</h3>
          ...
          <div style={{
            ...
            <h3 style={{ color: '#667eea', marginBottom: '10px' }}>⚖️ Processos</h3>
            <p style={{ color: '#6b7280', fontSize: '0.9rem' }}>
          ...
          <div style={{
            ...
            <h3 style={{ color: '#667eea', marginBottom: '10px' }}>👥 Clientes</h3>
            <p style={{ color: '#6b7280', fontSize: '0.9rem' }}>
              CRM integrado
            </p>
          </div>
