...
export const ADVOGAAI_TOOLS: AdvogaAITool[] = [
  {
    ...
    description:
      "Gera petições jurídicas com base em templates e dados do processo",
    category: "peticion",
    version: "1.0.0",
    ...
    parameters: [
      {
        ...
        validation: {
          enum: ["inicial", "contestacao", "recurso", "agravo", "embargos"],
        },
      },
      {
        name: "numero_cnj",
  ...
  },
  {
    ...
    description:
      "Calcula prazos processuais considerando feriados e regras específicas",
    ...
    parameters: [
      ...
      },
      {
        ...
        validation: {
          enum: ["contestacao", "recurso", "agravo", "embargos", "cumprimento"],
        },
      },
      {
        name: "court_type",
        ...
        validation: {
          enum: ["federal", "estadual", "trabalhista", "superior"],
        },
      },
      {
...
export class AdvogaAIToolsClient {
  ...
  constructor(baseUrl?: string, apiKey?: string) {
    this.baseUrl =
      baseUrl ||
      import.meta.env.VITE_ADVOGAAI_TOOLS_URL ||
      "https://api.advogaai.com/v1";
