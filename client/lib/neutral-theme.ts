...
export const FORBIDDEN_COLORS = [
  // Todos os amarelos
  '#ffff00', '#ffd700', '#ffb347', '#ffa500', '#ff8c00', '#daa520', '#b8860b',
  '#fff8dc', '#fffacd', '#ffffe0', '#fffff0', '#ffefd5', '#ffe4b5', '#ffdab9',
  '#eee8aa', '#f0e68c', '#bdb76b', '#f5deb3', '#ffe4e1', '#faf0e6',
  // Todos os limes/verdes claros
  '#32cd32', '#00ff00', '#adff2f', '#9acd32', '#90ee90', '#98fb98', '#00fa9a',
  '#00ff7f', '#7cfc00', '#7fff00', '#ccff00', '#c0ff8c',
  // Beiges e tons quentes que podem aparecer amarelos
  '#f5f5dc', '#ffe4c4', '#ffdead', '#d2b48c', '#deb887', '#f4a460', '#cd853f'
];
