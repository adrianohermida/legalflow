...
class SF4SavedViewManager {
  ...
  async saveView(
    view: Omit<SF4SavedView, "id" | "created_at" | "updated_at">,
  ): Promise<SF4SavedView | null> {
    if (!this.userId) {
  ...
  async loadViews(
    viewType: "inbox_publicacoes" | "inbox_movimentacoes",
  ): Promise<SF4SavedView[]> {
