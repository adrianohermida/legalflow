 ...
 */
export function generateUrl(route: string, params?: Record<string, string>): string {
  let url = route;
 ...
 */
export function getRouteParams(route: string, actualPath: string): Record<string, string> {
 ...
 */
export function generateBreadcrumb(path: string): Array<{ label: string; href: string }> {
