...
export function AdminBrandingConfig() {
  const { mode, toggleMode, colors, adminConfig, updateAdminConfig } =
    useNeutralTheme();
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-900">
                  {FORBIDDEN_COLORS.length} Cores Bloqueadas
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label htmlFor="theme-toggle" className="text-gray-900">
                  Modo Escuro
                </Label>
          ...
          {adminConfig.enabled && (
            <div className="space-y-4 p-4 border-2 border-blue-200 bg-blue-50 rounded-lg">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="primary-color" className="text-gray-900">
                    Cor Primária
                  </Label>
                ...
                <div>
                  <Label htmlFor="secondary-color" className="text-gray-900">
                    Cor Secundária
                  </Label>
                  <div className="flex mt-1">
                    <Input
                ...
                <div>
                  <Label htmlFor="accent-color" className="text-gray-900">
                    Cor de Destaque
                  </Label>
                  <div className="flex mt-1">
                    <Input
        ...
        <CardContent>
          <div className="flex items-center space-x-4">
            ...
            <div
              ...
              style={{
                backgroundColor: isColorSafe(testColor) ? testColor : "#ffffff",
              }}
            />
            <div>
        ...
        {showForbiddenColors && (
          <CardContent>
            ...
            <p className="text-sm text-red-600 mt-4 p-3 bg-red-50 rounded">
              ⚠️ Essas cores estão permanentemente bloqueadas para prevenir
              aparência amarelada
            </p>
          </CardContent>
        )}
