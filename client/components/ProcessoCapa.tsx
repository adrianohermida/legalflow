                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setPrintOptions((prev) => ({
                        ...prev,
                        includeArvoreProcessos: !!checked,
                      }))
                    }
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setPrintOptions((prev) => ({
                        ...prev,
                        includeMovimentacoes: !!checked,
                      }))
                    }
                  />
                  <Label htmlFor="movimentacoes">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span>
                    {formatDate(processo.data?.capa?.data_distribuicao) || "-"}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium">Data de Ajuizamento:</span>
                  <span>
                    {formatDate(processo.data?.capa?.data_ajuizamento) || "-"}
                  </span>
                </div>
                <div className="flex justify-between">
