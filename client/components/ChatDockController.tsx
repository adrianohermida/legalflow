...
export function ChatDockController({
  isOpen,
  onClose,
  userType,
}: ChatDockControllerProps) {
  ...
  const { data: conversationProps } = useQuery({
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updatePropertiesMutation.mutate({ status: value })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updatePropertiesMutation.mutate({ priority: value })
                      }
                    >
                      <SelectTrigger>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="font-medium text-xs truncate">
                        {thread.numero_cnj ||
                          thread.clientes?.nome ||
                          `Conversa ${thread.context_type}`}
                      </span>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {conversationProps.status && (
                  <Badge
                    className={cn(
                      "text-xs",
                      getStatusColor(conversationProps.status),
                    )}
                  >
                    {conversationProps.status}
                  </Badge>
                ...
                {conversationProps.priority && (
                  <Badge
                    className={cn(
                      "text-xs",
                      getPriorityColor(conversationProps.priority),
                    )}
                  >
                    {conversationProps.priority}
                  </Badge>
                )}
                {conversationProps.tags &&
                  conversationProps.tags.length > 0 && (
