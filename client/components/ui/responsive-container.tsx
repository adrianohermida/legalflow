...
export function CardContainer({ 
  ...
  return (
    <div className={cn(baseClasses.join(' '), className)}>
      {children}
    </div>
  );
}
...
export function HeaderContainer({ 
  ...
  return (
    <header className={cn(baseClasses.join(' '), className)}>
      <ResponsiveContainer padding="md" className="h-16 lg:h-20 flex items-center">
        {children}
      </ResponsiveContainer>
    </header>
  );
...
export function SidebarContainer({ 
  ...
  return (
    <aside className={cn(baseClasses.join(' '), className)}>
      {children}
    </aside>
  );
}
...
export function ContentContainer({ 
  ...
  return (
    <main className={cn(baseClasses.join(' '), className)}>
      {children}
    </main>
  );
}
