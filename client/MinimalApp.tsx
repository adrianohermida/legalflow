      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ margin: "0 0 10px 0", color: "#155724" }}>📊 Dashboard</h3>
          ...
          <div style={{
            ...
            <h3 style={{ margin: "0 0 10px 0", color: "#0066cc" }}>⚖️ Processos</h3>
          ...
          <div style={{
            ...
            <h3 style={{ margin: "0 0 10px 0", color: "#cc6600" }}>👥 Clientes</h3>
        ...
        <div style={{
          ...
          ✅ React Router: Funcionando<br />
          ✅ Vite HMR: Funcionando<br />
          ✅ CSS Global: Carregado<br />
