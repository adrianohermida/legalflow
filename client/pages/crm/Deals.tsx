...
const CRMDealsWithStripe: React.FC = () => {
  ...
  if (isLoading)
    return <LoadingState type="kanban" title="Carregando pipeline..." />;
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="flex justify-end space-x-2 pt-4">
                ...
                <Button
                  ...
                  disabled={!formData.title.trim() || !formData.value}
                >
                  Criar Deal
                </Button>
              </div>
              ...
              <CardContent className="space-y-3">
                {stageDeals.length === 0 ? (
                  ...
                  stageDeals.map((deal) => (
                    <Card
                      key={deal.id}
                      className="cursor-move border shadow-sm hover:shadow-md transition-shadow"
                    >
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                value={checkoutData.price_id}
                onValueChange={(value) =>
                  setCheckoutData((prev) => ({ ...prev, price_id: value }))
                }
              >
                <SelectTrigger>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="text-sm text-gray-600 space-y-1">
                <p>
                  <strong>Nome:</strong> {checkoutDeal?.contact_name}
                </p>
                <p>
                  <strong>Email:</strong> {checkoutDeal?.contact_email}
                </p>
                <p>
                  <strong>Deal:</strong> {checkoutDeal?.title} (
                  {formatCurrency(checkoutDeal?.value || 0)})
                </p>
              </div>
            </div>
          </div>
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="edit-expected-close">
                  Data prevista de fechamento
                </Label>
                <Input
