...
export function ProcessoOverview() {
  ...
  const { data: documentosRecentes = [] } = useQuery({
  ...
  return (
    <div className="space-y-6 p-6">
                ...
                <div className="max-h-64 overflow-y-auto space-y-3">
                  {chatLoading ? (
                    ...
                    <div className="text-center py-4 text-neutral-500">
                      ...
                      <p className="text-sm">
                        Inicie uma conversa sobre este processo
                      </p>
                    </div>
                  ) : (
              ...
              <div>
                ...
                <div className="mt-1">
                  {processo?.responsavel ? (
                    ...
                    >
                      {processo.responsavel.nome} (OAB{" "}
                      {processo.responsavel.oab})
                    </Badge>
                  ) : (
              ...
              {documentosRecentes.length === 0 ? (
                ...
                <div className="space-y-2">
                  {documentosRecentes.map((doc) => (
                    <div
                      key={doc.id}
                      className="flex items-center gap-2 p-2 rounded hover:bg-neutral-50"
                    >
      ...
      {/* Dialogs dos Atalhos */}
      <Dialog
        open={isAndamentoDialogOpen}
        onOpenChange={setIsAndamentoDialogOpen}
      >
        <DialogContent>
          <form
            onSubmit={(e) => {
          ...
          >
            ...
            <DialogFooter>
              <Button
                type="button"
                variant="outline"
                onClick={() => setIsAndamentoDialogOpen(false)}
              >
                Cancelar
              </Button>
              <Button
                type="submit"
                disabled={adicionarAndamentoMutation.isPending}
              >
                {adicionarAndamentoMutation.isPending && (
