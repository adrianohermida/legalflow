      ...
      <Stack spacing="lg">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className={`${TYPOGRAPHY_PATTERNS.body} text-gray-600`}>
                Demonstrações dos sistemas de design mobile-first e estado
                global padronizado implementados no Legalflow.
              </p>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">
                  Hook unificado <code>useAsyncOperation()</code> com estados
                  padronizados de loading, erro e estado vazio. Reduz código
                  boilerplate em 70% e garante consistência visual.
                </p>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      <li>
                        • <strong>Estados unificados:</strong> Loading, Error,
                        Empty consistentes
                      </li>
                      <li>
                        • <strong>Retry automático:</strong> Botão de retry em
                        erros
                      </li>
                      <li>
                        • <strong>Componentes prontos:</strong>{" "}
                        LoadingComponent, ErrorComponent, EmptyComponent
                      </li>
                      <li>
                        • <strong>Hooks especializados:</strong> useAsyncList,
                        useAsyncTable, useAsyncForm
                      </li>
                    </ul>
                  </div>
          ...
          <TabsContent value="mobile-first" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">
                  Sistema completo de design responsivo com breakpoints
                  consistentes, componentes adaptativos e hooks para detecção de
                  dispositivos.
                </p>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <ul className="text-sm text-green-800 space-y-1">
                      <li>
                        • <strong>Breakpoints consistentes:</strong> xs(475px),
                        sm(640px), md(768px), lg(1024px), xl(1280px),
                        2xl(1536px)
                      </li>
                      <li>
                        • <strong>Componentes responsivos:</strong>{" "}
                        ResponsiveGrid, Container, Flex
                      </li>
                      <li>
                        • <strong>Hooks úteis:</strong> useBreakpoint,
                        useIsMobile, useResponsiveValue
                      </li>
                      <li>
                        • <strong>Padrões prontos:</strong> GRID_PATTERNS,
                        TYPOGRAPHY_PATTERNS, SPACING_PATTERNS
                      </li>
                    </ul>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Documentação completa do sistema de estado global
                    padronizado.
                  </p>
                  <Badge variant="outline">
                    STANDARDIZED_GLOBAL_STATE_COMPLETE.md
                  </Badge>
                </div>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <Badge variant="outline">
                    MOBILE_FIRST_MIGRATION_EXAMPLE.md
                  </Badge>
                </div>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <Badge variant="outline">
                    ROUTE_CONSOLIDATION_COMPLETE.md
                  </Badge>
                </div>
              </div>
            </CardContent>
        ...
        <SectionContainer>
          <div className="text-center space-y-4">
            ...
            <p
              className={`${TYPOGRAPHY_PATTERNS.body} text-gray-600 max-w-2xl mx-auto`}
            >
              Todos os sistemas estão implementados e prontos para uso em
              produção. Use os exemplos acima como referência para implementar
              novos componentes seguindo os padrões estabelecidos.
            </p>
          </div>
        </SectionContainer>
      </Stack>
