  ...
  const updateStepStatus = (
    ...
    setResults((prev) =>
      prev.map((result, index) =>
        index === stepIndex ? { ...result, status, message, details } : result,
      ),
    );
  };
  ...
  const executeStep = async (
    ...
    try {
      const response = await fetch(
        `/.netlify/functions/integrity-step${stepNumber}`,
        {
          method: "POST",
          headers: {
    ...
    <div className="container mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Execute as correções de integridade identificadas na auditoria do
          sistema
        </p>
      </div>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Adiciona constraints de chaves estrangeiras ausentes para
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Cria índices compostos e de texto para otimizar queries
                frequentes
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Cria views e funções para monitoramento contínuo da integridade
                dos dados
              </p>
            </div>
          </CardContent>
