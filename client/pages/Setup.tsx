      ...
      {!showInstructions ? (
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="bg-brand-100 text-brand-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-semibold">
                    1
                  </div>
                  <div>
              ...
              <Alert>
                <AlertDescription>
                  <strong>Importante:</strong> Use apenas a chave pública
                  (anon). Nunca use a chave de serviço (service_role) no
                  frontend.
                </AlertDescription>
              </Alert>
            </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <Alert>
              <AlertDescription>
                <strong>Próximo passo:</strong> Configure as variáveis de
            ...
            <div>
              ...
              <p className="text-sm text-neutral-600 mb-3">
                Crie um arquivo{" "}
                <code className="bg-neutral-100 px-1 rounded">.env</code> na
                raiz do projeto:
              </p>
...
VITE_DEV_MODE=true`}
            ...
            <div>
              <h3 className="font-semibold mb-2">
                Opção 2: Variáveis do Sistema (Produção)
              </h3>
              <p className="text-sm text-neutral-600 mb-3">
                Configure diretamente nas variáveis de ambiente do seu provedor
                de hospedagem
              </p>
            ...
            <Alert>
              <AlertDescription>
                ...
                desenvolvimento e recarregue a página.
              </AlertDescription>
            </Alert>
