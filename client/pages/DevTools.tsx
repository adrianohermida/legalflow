...
const DevTools: React.FC = () => {
  ...
  const runSeed = async () => {
    ...
    try {
      ...
      const { data: planos } = await supabase.from('legalflow.planos_pagamento').insert(planosData).select();
      setSeedProgress(75);
  ...
  const importData_func = async () => {
    ...
    try {
      ...
      if (data.jornadas?.length > 0) {
        await supabase.from('legalflow.journey_instances').upsert(data.jornadas);
      }
      ...
      if (data.financeiro?.length > 0) {
        await supabase.from('legalflow.planos_pagamento').upsert(data.financeiro);
      }
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : 'Falha ao importar dados',
        variant: 'destructive'
      });
    } finally {
  ...
  const clearAllData = async () => {
    ...
    try {
      ...
      await supabase.from('legalflow.activities').delete().neq('id', '00000000-0000-0000-0000-000000000000');
      await supabase.from('legalflow.tickets').delete().neq('id', '00000000-0000-0000-0000-000000000000');
      await supabase.from('legalflow.deals').delete().neq('id', '00000000-0000-0000-0000-000000000000');
      await supabase.from('legalflow.planos_pagamento').delete().neq('id', '00000000-0000-0000-0000-000000000000');
      await supabase.from('legalflow.journey_instances').delete().neq('id', '00000000-0000-0000-0000-000000000000');
      await supabase.from('legalflow.timeline').delete().neq('id', '00000000-0000-0000-0000-000000000000');
      await supabase.from('legalflow.processos').delete().neq('cnj', 'dummy');
      await supabase.from('legalflow.clientes').delete().neq('cpfcnpj', 'dummy');
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Ferramentas de Desenvolvimento</h1>
                ...
                {exportResult && (
                  <Alert className="border-green-200 bg-green-50">
                    ...
                    <AlertDescription className="text-green-800">
                      ...
                      <br />
                      <small>Inclui: cliente, processo, timeline, jornadas, documentos, agenda, financeiro, tickets, activities</small>
                    </AlertDescription>
                  </Alert>
                )}
              </div>
              ...
              <div className="space-y-4">
                ...
                <Alert className="border-blue-200 bg-blue-50">
                  ...
                  <AlertDescription className="text-blue-800">
                    <strong>Atenção:</strong> Import usa UPSERT - dados existentes serão atualizados.
                    Use apenas em ambiente de staging.
                  </AlertDescription>
                </Alert>
              </div>
            </CardContent>
